define(["base/js/utils"], function(__WEBPACK_EXTERNAL_MODULE_22__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
  ...
  var display_list = function(data, state) { 
    ...
    for (j in pnames) {
      ...
      console.log("TZ test newuri", data.uri);
      if (data.uri) {
        if (data.uri.endsWith('/')) { 
  ...
  var display_search_result = function(data, state) {
    ...
    console.log("TZ test results", data);
    for (idx in res) {
      var entry = res[idx];
      var pf = (function(path) {
        return function() {
...
module.exports = {"datasets":[{"name":"BraveNewCoin Daily Global Price Index for Bitcoin","description":"Updated daily, this database contains Brave New Coin's Global Weighted Averages.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/15084/bnc_logo.png","code":"BNC3/GWA_BTC","outlink":"https://quandl-production-data-upload.s3.amazonaws.com/uploads/vendor/profile_image/27/thumb_bnc_logo.png","frequency":"Monthly","refreshed":"2 months ago","provider":"Quandl"},{"name":"Zillow Real Estate Research","description":"The Zillow Home Value Index is Zillow's estimate of the median market value of zillow home value index - top tier within the city of Pomfret, NY. This data is calculated by Zillow Real Estate Research (www.zillow.com/research) using their database of 110 million homes.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/797/zillow.jpg","code":"ZILLOW/C4374_ZHVITT","outlink":"https://www.quandl.com/data/ZILLOW/C4374_ZHVITT-Zillow-Home-Value-Index-City-Zillow-Home-Value-Index-Top-Tier-Pomfret-NY","frequency":"Monthly","refreshed":"2 months ago","provider":"Quandl"},{"name":"Tokyo Stock Exchange","description":"End of day unadjusted prices and additional information for companies trading on the Tokyo Stock Exchange in Japan.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/473/tokyo-stock-exchange.png","code":"TSE/1494","outlink":"https://www.quandl.com/data/TSE/1494-One-Etf-High-Dividend-Japan-Equity-1494","frequency":"Daily","refreshed":"8 hours ago","provider":"Quandl"},{"name":"NASDAQ OMX Global Index Data","description":"Over 35,000 global indexes published by NASDAQ OMX including Global Equity, Fixed Income, Dividend, Green, Nordic, Sharia and more. Daily data.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/10471/thumb_thumb_nasdaqomx_fao.jpg","code":"NASDAQOMX/LDRIG05","outlink":"https://www.quandl.com/data/NASDAQOMX/LDRIG05-LadderRite-0-5year-USD-Corporate-Bond-Index-LDRIG05","frequency":"Daily","refreshed":"20 hours ago","provider":"Quandl"},{"name":"Intercontinental Exchange Futures Data","description":"Futures data for softs, grains, energy products and financial instruments, with historical contracts going back decades.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/6894/intercontinental-exchange-futures-data.png","code":"ICE/WAN2019","outlink":"https://www.quandl.com/data/ICE/WAN2019-Milling-Wheat-Futures-July-2019-WAN2019","frequency":"Daily","refreshed":"19 hours ago","provider":"Quandl"},{"name":"National Stock Exchange of India","description":"Stock and index data from the National Stock Exchange of India.","img":"https://quandl-production-data-upload.s3.amazonaws.com/uploads/vendor/profile_image/16/thumb_exchange-data.jpg","code":"NSE/DOLLAR","outlink":"https://www.quandl.com/data/NSE/DOLLAR-Dollar-Industries-Limited","frequency":"Daily","refreshed":"8 hours ago","provider":"Quandl"},{"name":"Yale Department of Economics","description":"Publishes data related to the stock and housing markets; price data for common indexes, interest rates, earnings, dividends, house prices, and CPI.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/175/images-1.jpg","code":"YALE/RBCI","outlink":"https://www.quandl.com/data/YALE/RBCI-Historical-Housing-Market-Data-Real-Building-Cost-Index","frequency":"Annual","refreshed":"Last year","provider":"Quandl"},{"name":" London Bullion Market Association","description":"An international trade association in the London gold and silver market, consisting of central banks, private investors, producers, refiners, and other agents.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/139/Screen_Shot_2014-08-11_at_10.32.40_AM.png","code":"LBMA/GOLD","outlink":"https://www.quandl.com/data/LBMA/GOLD-Gold-Price-London-Fixing","frequency":"Daily","refreshed":"5 hours ago","provider":"Quandl"},{"name":"U.S. Energy Information Administration Data","description":"US national and state data on production, consumption and other indicators on all major energy products, such as electricity, coal, natural gas and petroleum.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/661/thumb_us-energy-information-administration-data.jpg","code":"EIA/AEO_2016_REF_NO_CPP_PRCE_NA_COMM_NA_NG_NA_NENGL_Y13DLRPMCF_A","outlink":"https://www.quandl.com/data/EIA/AEO_2016_REF_NO_CPP_PRCE_NA_COMM_NA_NG_NA_NENGL_Y13DLRPMCF_A-Natural-Gas-Delivered-Commercial-New-England-No-CPP-AEO2016","frequency":"Annual","refreshed":"Last year","provider":"Quandl"},{"name":"LIFFE Futures Data","description":"Futures data from LIFFE for a variety of equities, softs and grains. Contains years of history for many futures.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/1304/thumb_nyse_liffe_logo.jpg","code":"LIFFE/TK2019","outlink":"https://www.quandl.com/data/LIFFE/TK2019-UK-Feed-Wheat-Future-May-2019-TK2019","frequency":"Daily","refreshed":"4 hours ago","provider":"Quandl"},{"name":"World Bank World Development Indicators","description":"Most current and accurate development indicators, compiled from officially-recognized international sources.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/13565/icon.jpg","code":"WWDI/PYF_SL_UEM_1524_MA_ZS","outlink":"https://www.quandl.com/data/WWDI/PYF_SL_UEM_1524_MA_ZS-Unemployment-youth-male-of-male-labor-force-ages-15-24-French-Polynesia","frequency":"Annual","refreshed":"Last year","provider":"Quandl"},{"name":"British Petroleum","description":"BP is a large energy producer and distributor. It provides data on energy production and consumption in individual countries and larger subregions.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/154/bp.png","code":"BP/COAL_PROD_O_MNG","outlink":"https://www.quandl.com/data/BP/COAL_PROD_O_MNG-Coal-Production-Oil-Equivalent-Mongolia","frequency":"Annual","refreshed":"Last year","provider":"Quandl"}]}
...
module.exports = {"datasets":[{"name":"Global Food Prices Database","description":"The Global Food Prices Database has data on food prices (e.g., beans, rice, fish, and sugar) for 76 countries and some 1,500 markets.","img":"https://quandl-data-upload.s3.amazonaws.com/uploads/source/profile_image/13138/ueng.png","code":"","dataid":"8ed86473-7fb3-4e6c-8fac-60ae1f3358b5","outlink":"https://public.enigma.com/datasets/467d9a94-1842-41af-84f5-52b273b1ca02","frequency":"Annual","refreshed":"Last month","provider":"Enigma"}]}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./dataBrowser.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./dataBrowser.css");
