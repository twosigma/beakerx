...
(function () {
  ...
  module.factory('bkHelper', function ($location, $rootScope, $httpParamSerializer, $uibModal, bkUtils, bkCoreManager, bkSessionManager, bkEvaluatorManager, bkDebug, bkElectron, bkPublicationAuth, GLOBALS) {
    ...
    var bkHelper = {
      ...
      show3ButtonModal: function (msgBody, msgHeader, yesCB, noCB, cancelCB, yesBtnTxt, noBtnTxt, cancelBtnTxt) {
      ...
      insertNewSectionWithLevel: function (level) {
        ...
        if (currentCellId) {
          var cell = notebookCellOp.getCell(currentCellId);
          var evaluator = cell.type === 'section' ? cell.evaluator : defaultEvaluator;
        ...
        if (modelOutput.result.object !== undefined) {
          if (modelOutput.result.object.payload === undefined) {
            if (modelOutput.result.object.outputdata.length > 0) {
              modelOutput.result.object.payload = {
                type: "Results",
            ...
            modelOutput.result.object.payload = {
              type: "Results",
              outputdata: modelOutput.result.object.outputdata,
              payload: modelOutput.result.object.payload
            };
          }
        }
