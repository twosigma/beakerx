...
/**
 * M_bkApp
 * This is the main module for the beaker notebook application. The module has a directive that holds the menu bar as
 * well as the notebook view. The module also owns the centralized cell evaluation logic.
 */
(function () {
    'use strict';
        ...
        return {
                ...
                bkNotebookVersionManager)
            {
                ...
                window.onbeforeunload = function (e) {
                    // TODO, we should warn users, but I can't find a way to properly perform cancel after warning
                    bkAppEvaluate.cancel();
...
//                    }
                ...
                $scope.loading = true;
                // set the notebook model to empty so the UI is blank instead of leftover from previous model
