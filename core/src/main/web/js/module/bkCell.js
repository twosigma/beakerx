...
/**
 * M_bkCell
 * This module contains directives for cells. The bkCell directive is the base untyped cell container which can
 * include a typed cell. Most of the typed cell directive, except for the code cell, goes into this module too. The
 * module also holds the directive for cell UI behavior, for example the cell menus.
 */
(function () {
    'use strict';
     ...
     * - conceptually, a cell is 'cell model' + 'view model'(an example of what goes in to the view model is code cell
     * bg color)
     * - A bkCell is generically corresponds to a portion of the notebook model (currently, it is always a branch in the
     * hierarchy)
