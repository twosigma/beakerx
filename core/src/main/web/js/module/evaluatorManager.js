...
/**
 * M_evaluatorManager
 * This module loads/unloads plugins and evaluators and maintains the lists. It also serves as the single point of
 * contact of all eval plugins.
 */
(function () {
    'use strict';
        ...
        .factory('evaluatorManager', function (
            ...
            var setupPlugin = function (nameOrUrl, makeEvaluator, cb) {
                ...
                if (pluginObj) {
                    ...
                    updateEvaluatorsAndLoadingPlugins();
                    generalUtils.loadJS(url, function (){}, function () {
