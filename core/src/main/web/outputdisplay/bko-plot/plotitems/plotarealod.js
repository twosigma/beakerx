...
(function() {
  ...
  var retfunc = function(plotUtils) {
    ...
    var PlotAreaLOD = function(data){
      $.extend(true, this, data);
      this.format();
    };

    PlotAreaLOD.prototype.render = function(scope){
      if (this.shown === false) {
        this.clear(scope);
        return;
      }
    ...
    PlotAreaLOD.prototype.getRange = function(){
    ...
    PlotAreaLOD.prototype.filter = function(scope) {
      var eles = this.elements;
    ...
    PlotAreaLOD.prototype.prepare = function(scope) {
    ...
    PlotAreaLOD.prototype.draw = function(scope) {
      var svg = scope.maing;
    ...
    PlotAreaLOD.prototype.clear = function(scope) {
      scope.maing.select("#" + this.id).remove();
    };

    return PlotAreaLOD;
  };
  beaker.bkoFactory('PlotAreaLOD', ['plotUtils', retfunc]);
})();
