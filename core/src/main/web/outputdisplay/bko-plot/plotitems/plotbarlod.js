...
(function() {
  ...
  var retfunc = function(plotUtils) {
    ...
    var PlotBarLOD = function(data) {
      $.extend(true, this, data);
      this.format();
    };

    PlotBarLOD.prototype.render = function(scope) {
      if (this.shown == false) {
        this.clear(scope);
        return;
      }
    ...
    PlotBarLOD.prototype.getRange = function(){
    ...
    PlotBarLOD.prototype.format = function() {
    ...
    PlotBarLOD.prototype.filter = function(scope) {
      var eles = this.elements;
    ...
    PlotBarLOD.prototype.prepare = function(scope) {
      var w = this.width, sw;
    ...
    PlotBarLOD.prototype.draw = function(scope) {
      var svg = scope.maing;
    ...
    PlotBarLOD.prototype.clear = function(scope) {
      scope.maing.select("#" + this.id).remove();
    };

    return PlotBarLOD;
  };
  beaker.bkoFactory('PlotBarLOD', ['plotUtils', retfunc]);
})();
