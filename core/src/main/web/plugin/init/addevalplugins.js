...
(function() {
  ...
  window.bkInit.getEvaluatorUrlMap = function() {
    return {
      ...
      "Groovy": { url : "./plugins/eval/groovy/groovy.js", bgColor: "#6497A9", fgColor: "#FFFFFF", borderColor: "", shortName: "Gv", tooltip: "the language that deserves the name JavaScript" },
      ...
      "Clojure": { url : "./plugins/eval/clojure/clojure.js", bgColor: "#5881d8", fgColor: "#FFFFFF", borderColor: "", shortName: "Cj", tooltip: "a practical Lisp for the JVM" },
