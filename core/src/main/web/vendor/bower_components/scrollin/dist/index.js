...
var defaultOptions = { top: 0, bottom: 0, left: 0, right: 0 };
...
function isVisible(elm, options) {
  ...
  return rect.bottom - options.bottom > 0 && rect.right - options.right > 0 && rect.left + options.left < (window.innerWidth || document.documentElement.clientWidth) && rect.top + options.top < (window.innerHeight || document.documentElement.clientHeight);
}
...
},{"lodash.defaults":5,"lodash.throttle":8}],2:[function(require,module,exports){
/**
...
},{"lodash._getnative":2}],5:[function(require,module,exports){
(function (global){
/**
 * lodash 4.0.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
...
},{"lodash.assigninwith":3,"lodash.rest":7}],6:[function(require,module,exports){
(function (global){
/**
 * lodash 4.0.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
