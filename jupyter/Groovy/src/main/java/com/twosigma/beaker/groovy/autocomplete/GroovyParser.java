...
public class GroovyParser extends Parser {
	...
	private static final String[] _LITERAL_NAMES = {
		...
		"'|='", "';'", "'.'", "','", "'@'", "'='", "'<'", "'>'", "':'", "'|'", 
		"'!'", "'~'", "'*'", null, "'%'", "'+'", "'-'", "'&'", "'^'", "'?'", "'as'", 
		"'instanceof'", null, "'abstract'", "'static'", "'final'", "'transient'", 
	...
	public final EnumDeclarationContext enumDeclaration() throws RecognitionException {
		...
		try {
			...
			match(KW_ENUM);
			setState(244);
			((EnumDeclarationContext)_localctx).IDENTIFIER = match(IDENTIFIER);
	...
	private boolean constructorDeclaration_sempred(ConstructorDeclarationContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
			return  _input.LT(_input.LT(1).getType() == VISIBILITY_MODIFIER ? 2 : 1).getText().equals(currentClassName) ;
		}
		return true;
	}
