...
public class CompleteHandler extends AbstractHandler {
    ...
    public void handle(Message message) throws NoSuchAlgorithmException {
        ...
        reply.setHeader(new Header(COMPLETE_REPLY, message));
    ...
    public GroovyClassLoader getCompiler() {
        return compiler;
    }

    public void setCompiler(GroovyClassLoader compiler) {
        this.compiler = compiler;
    }

    public static String getCOMPLETE_CHARS() {
        return COMPLETE_CHARS;
    }

    public static String getINCOMPLETE_CHARS() {
