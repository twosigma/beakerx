...
define([
  ...
  function createScope(wrapperId) {
    ...
    var unregisterOutputExpandEventListener = function(){}; // used for deregistering listener
    ...
    scope.init = function(model, destroy) {
      ...
      var cellHighlightersDataRev = scope.cellHighlightersData.slice().reverse();
