...
public class AddStaticImportMagicCommand extends ImportMagicCommand {

  public AddStaticImportMagicCommand(KernelFunctionality kernel, MessageCreator messageCreator) {
    super(ADD_STATIC_IMPORT, "<classpath>", Sets.newHashSet(MagicCommandType.LINE), messageCreator, kernel);
  }
