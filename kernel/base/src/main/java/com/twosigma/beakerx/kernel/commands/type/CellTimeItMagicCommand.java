...
public class CellTimeItMagicCommand extends AbstractTimeMagicCommand {

  public CellTimeItMagicCommand(KernelFunctionality kernel, MessageCreator messageCreator) {
    super(TIMEIT_CELL, "", Sets.newHashSet(MagicCommandType.CELL), messageCreator, kernel);
  }
