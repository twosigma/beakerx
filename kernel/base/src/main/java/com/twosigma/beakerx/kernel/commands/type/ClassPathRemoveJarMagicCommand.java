...
public class ClassPathRemoveJarMagicCommand extends ClassPathMagicCommand {
  ...
  public ClassPathRemoveJarMagicCommand(KernelFunctionality kernel, MessageCreator messageCreator) {
    super(CLASSPATH_REMOVE, "<jar path>", Sets.newHashSet(MagicCommandType.LINE), messageCreator, kernel);
  }
