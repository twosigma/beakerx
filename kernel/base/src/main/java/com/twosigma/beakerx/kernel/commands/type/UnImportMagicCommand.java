...
public class UnImportMagicCommand extends ImportMagicCommand {

  public UnImportMagicCommand(KernelFunctionality kernel, MessageCreator messageCreator) {
    super(UNIMPORT, "<classpath>", Sets.newHashSet(MagicCommandType.LINE), messageCreator, kernel);
  }
