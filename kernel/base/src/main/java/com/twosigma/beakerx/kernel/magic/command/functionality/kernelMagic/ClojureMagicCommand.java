...
public class ClojureMagicCommand extends KernelMagicAliasCommand {

    public static final String CLOJURE = "%%clojure";
    private static final String KERNEL_NAME = "clojure";

    public ClojureMagicCommand(KernelFunctionality kernel) {
        super(kernel);
    }
