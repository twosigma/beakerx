...
public class ImportsTest {
  ...
  public void shouldNotHaveDuplications() throws Exception {
    //given
    ImportPath anImport = new ImportPath("com.twosigma.beakerx.widget.integer.IntSlider");
    //when
    ...
    //then
    assertThat(imports.getImportPaths()).containsExactly(new ImportPath("com.twosigma.beakerx.widget.integer.IntSlider"));
  }
}