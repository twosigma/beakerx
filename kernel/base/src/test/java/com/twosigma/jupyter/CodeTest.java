...
import static com.twosigma.beaker.jupyter.commands.MagicCommand.CLASSPATH_ADD_JAR;
...
public class CodeTest {
  ...
  public void shouldReadAllMagicCommands() throws Exception {
    ...
    assertThat(result.takeCodeWithoutCommand()).isEqualTo(new Code("code code code"));
  }
}