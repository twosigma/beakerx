...
public class ClojureCommKernelControlSetShellHandlerTest {

  private ClojureKernelMock kernelTest;
  private ClojureCommKernelControlSetShellHandler commHandler;
  private Message message;

  @Before
  public void setUp() throws Exception {
    kernelTest = new ClojureKernelMock();
    commHandler = new ClojureCommKernelControlSetShellHandler(kernelTest);
    message = new Message();
  }
