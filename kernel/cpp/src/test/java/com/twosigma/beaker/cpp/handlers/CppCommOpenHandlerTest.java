...
public class CppCommOpenHandlerTest {

  private CppKernelFunctionalityTest kernel;
  private CppCommOpenHandler commOpenHandler;
  ...
  public void setUp() throws IOException {
    ...
    commOpenHandler = new CppCommOpenHandler(kernel);
  }
