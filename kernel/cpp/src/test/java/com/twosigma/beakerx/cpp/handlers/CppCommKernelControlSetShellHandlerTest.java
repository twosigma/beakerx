...
public class CppCommKernelControlSetShellHandlerTest {

  private CppKernelFunctionalityTest kernelTest;
  private CppCommKernelControlSetShellHandler commHandler;
  private Message message;

  @Before
  public void setUp() throws Exception {
    kernelTest = new CppKernelFunctionalityTest();
    commHandler = new CppCommKernelControlSetShellHandler(kernelTest);
    message = new Message();
  }
