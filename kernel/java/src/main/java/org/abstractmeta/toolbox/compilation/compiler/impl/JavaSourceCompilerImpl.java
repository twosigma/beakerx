...
public class JavaSourceCompilerImpl implements JavaSourceCompiler {
  ...
  @Override
  public boolean compile(CompilationUnit compilationUnit, String... options) {
  ...
  protected boolean compile(JavaCompiler compiler, ClassLoader parentClassLoader, CompilationUnit compilationUnit, String... options) {
    if (compiler == null) {
