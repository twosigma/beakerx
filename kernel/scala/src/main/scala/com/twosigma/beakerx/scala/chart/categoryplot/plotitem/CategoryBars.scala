...
class CategoryBars extends com.twosigma.beakerx.chart.categoryplot.plotitem.CategoryBars with CategoryBarsProperties

trait CategoryBarsProperties extends BasedCategoryGraphicsProperties {
