...
class CategoryLines extends com.twosigma.beakerx.chart.categoryplot.plotitem.CategoryLines with CategoryLinesProperties

trait CategoryLinesProperties extends CategoryGraphicsProperties {
