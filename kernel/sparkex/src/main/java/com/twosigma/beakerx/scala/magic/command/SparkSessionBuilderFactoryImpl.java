...
public class SparkSessionBuilderFactoryImpl implements SparkSessionBuilderFactory {

  @Override
  public SparkSessionBuilder newInstance(SparkConf sparkConf) {
    return new SparkSessionBuilderImpl(SparkSession.builder().config(sparkConf));
  }
