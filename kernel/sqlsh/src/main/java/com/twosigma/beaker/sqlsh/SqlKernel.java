...
public class SqlKernel extends Kernel {
  ...
  public SqlKernel(String sessionId, Evaluator evaluator, ConfigurationFile configurationFile) {
  ...
  public static void main(final String[] args) throws InterruptedException, IOException {
    KernelRunner.run(() -> {
      String id = uuid();
      return new SqlKernel(id, new SQLEvaluator(id, id), new KernelConfigurationFile(args));
    });
  }
}
