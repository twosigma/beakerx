 ...
 */
package com.twosigma.beaker.cpp.rest;

import com.google.inject.Singleton;
import com.twosigma.beaker.jvm.object.SimpleEvaluationObject;
import com.twosigma.beaker.cpp.utils.CppEvaluator;
...
@Singleton
public class CppShellRest {

  private final Map<String, CppEvaluator> shells = new HashMap<>();

  public CppShellRest() throws IOException {}
    ...
    throws InterruptedException, MalformedURLException
  {
    ...
    if (shellId.isEmpty() || !this.shells.containsKey(shellId)) {
      ...
      CppEvaluator cpp = new CppEvaluator(shellId, sessionId);
      this.shells.put(shellId, cpp);
      return shellId;
    }
    return shellId;
  }
