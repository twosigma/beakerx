...
# this will be set after this module is imported
session_id = ''
...
def set4(var, val, unset, sync):
    args = {'name': var, 'session':session_id, 'sync':sync}
    if not unset:
