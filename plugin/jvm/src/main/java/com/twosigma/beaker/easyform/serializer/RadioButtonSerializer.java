...
public class RadioButtonSerializer
    extends AbstractEasyFormComponentSerializer<RadioButtonComponent> {

  @Override
  protected void writeSubclassFields(final JsonGenerator jgen,
                                     final RadioButtonComponent component) throws IOException {
