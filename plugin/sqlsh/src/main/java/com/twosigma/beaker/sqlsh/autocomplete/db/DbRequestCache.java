...
public class DbRequestCache implements DbCache {
  ...
  public DbRequestCache() {
    super();
    fieldsCache =
        new ConcurrentHashMap<String, Map<String, Map<String, Map<String, List<String>>>>>();
  ...
  public void putTableNames(final String url, String schemaName, String key, List<String> values) {
    if (values != null) {
      Map<String, Map<String, List<String>>> uriCache =
      ...
      if (((ConcurrentHashMap<String, Map<String, List<String>>>) uriCache).putIfAbsent(schemaName,
          schemaCache) != null) {
  ...
  @Override
  public List<String> getTableFieldNames(final String url, String schemaName, String tableName,
      String key) {
    ...
    final Map<String, Map<String, List<String>>> schemaCache =
        uriCache.get(checkSchema(uriCache, schemaName));
  ...
  @Override
  public void putTableFieldNames(final String url, String schemaName, String tableName, String key,
      List<String> values) {
    if (values != null) {
      Map<String, Map<String, Map<String, List<String>>>> uriCache =
          new ConcurrentHashMap<String, Map<String, Map<String, List<String>>>>();

      if (fieldsCache.putIfAbsent(url, uriCache) != null) {
        uriCache = fieldsCache.get(url);
      }

      Map<String, Map<String, List<String>>> schemaCache =
          new ConcurrentHashMap<String, Map<String, List<String>>>();

      schemaName = checkSchema(uriCache, schemaName);
      if (((ConcurrentHashMap<String, Map<String, Map<String, List<String>>>>) uriCache)
          .putIfAbsent(schemaName, schemaCache) != null) {
        schemaCache = uriCache.get(schemaName);
      }

      Map<String, List<String>> tableCache = new ConcurrentHashMap<String, List<String>>();

      if (((ConcurrentHashMap<String, Map<String, List<String>>>) schemaCache)
          .putIfAbsent(tableName, tableCache) != null) {
