...
cmdclass['js'] = install_npm(
    path=pjoin('beakerx', 'js'), 
    build_dir=pjoin('beakerx', 'js', 'dist'),
    source_dir=pjoin('beakerx', 'js', 'src')
)
...
# cmdclass['beakerx'] = run_gradle(cmd=':beakerx:install')
...
setup_args = dict(
    ...
    version             = get_version(pjoin('beakerx', 'beakerx', '_version.py')),
    ...
    data_files          = [
        ('share/jupyter/nbextensions/beakerx', [
            'beakerx/beakerx/static/extension.js',
            'beakerx/beakerx/static/index.js',
            'beakerx/beakerx/static/index.js.map',
        ]),
    ],
    install_requires    = [
