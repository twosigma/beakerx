...
(function () {
     ...
     * - we've made this global. We should revisit this decision and figure out the best way to load plugins dynamically
     * - it mostly should just be a subset of bkUtil
     */
    module.factory('bkHelper', function (
        bkBaseSessionModel,
        bkCoreManager,
        bkShare)
    {
        var bkHelper = {
            ...
            loadNotebook: function (notebookModel, alwaysCreateNewEvaluators, notebookUri, sessionID) {
                return bkCoreManager.getBkApp().loadNotebook(notebookModel, alwaysCreateNewEvaluators, notebookUri, sessionID);
            },
            ...
            showOkCancelModal: function (msgBody, msgHeader, okCB, cancelCB, okBtnTxt, cancelBtnTxt) {
                if (!msgHeader) { msgHeader = "Question..."; }
            ...
            showYesNoCancelModal: function (msgBody, msgHeader, yesCB, noCB, cancelCB, yesBtnTxt, noBtnTxt, cancelBtnTxt) {
                if (!msgHeader) { msgHeader = "Question..."; }
                var close = function (result) {
                    if (result === "Yes") {
                        yesCB ? yesCB() : null;
