 ...
 * This adds a menu items to the File menu: open...(IPython), that loads IPython notebook and convert it to a Beaker noteboook
 */
(function () {
    'use strict';
                ...
                items: [
                    {
                        ...
                        action: function () {
                            bkHelper.showFileChooser(
                                function (path) {
                                    bkHelper.openURI(encodeURI(IPYTHON_PATH_PREFIX + ":/" + path));
                                },
