...
describe('(Clojure) Testing of EasyForm', function () {

  easyFormBaseObject.constructor.apply(this, ['Groovy']);

  beforeAll(function () {
    beakerxPO = new BeakerXPageObject();
    beakerxPO.runNotebookByUrl('/test/ipynb/clojure/EasyFormTest.ipynb');
  }, 2);
  ...
  describe('(Clojure) EasyForm Actions ', function(){
    var inputs;
  ...
  describe('(Clojure) IntSlider widget in EasyForm ', function(){
