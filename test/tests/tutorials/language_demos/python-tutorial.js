...
describe('Python Tutorial', function () {
    ...
    it('IPython Examples', function () {
        ...
        beakerPO.checkSubString(arrStr.get(2), '7.921', 0, 5);
        beakerPO.checkSubString(arrStr.get(2), '8.085', 0, 5);
        beakerPO.checkSubString(arrStr.get(2), '8.132', 0, 5);
        beakerPO.checkSubString(arrStr.get(2), '8.119', 0, 5);
        beakerPO.checkSubString(arrStr.get(2), '8.196', 0, 5);
        beakerPO.checkSubString(arrStr.get(2), '8.206', 0, 5);
        beakerPO.checkSubString(arrStr.get(2), '8.258', 0, 5);
